			...
			$medic_cnt = mysqli_num_rows( $resultAlertMedic);
				 ...
				 <div class="column">
                    <div class="alert" ><a href="Notification.php">
						...
						<p>
                         			 <div style="margin-bottom: 2%; margin-top: 3%;margin-left: -23%;"> <font size="5px" color="#47b6c7"> &nbsp;
				...
				<div class="column" style="margin-top: 5%;">
                    <div class="alert" ><a href="Notification.php">
                        <img src="./img/doctor (2).png" alt="Avatar" style="width:15%; margin-top: 7%; margin-left:6%;" class="img2">
                            <p>
                         			 <div style="margin-bottom: 2%;margin-top: 1%;margin-left: 23%;"> <font size="5px" color="#47b6c7"> &nbsp;
										  Time to see doctor <?php echo $alertBooking['name']; ?>&nbsp;!</font></div>
                               		 <div style="margin-bottom: 2%;margin-left: 1%;"> <font size='5' color="#a4a4a4"> &nbsp; 
