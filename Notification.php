                        ...
                        <img src="./img/pills.png" alt="Avatar" style="width:80px; margin-top: 25px; margin-left: 10px;" class="img2">
							...
							<!-- Queue time alart of that pill and show -->
							  <?php $medicid = $medic['medicine_id'];
									$mysql_qry3 = "SELECT * FROM `medical`m JOIN history_medicine hi ON m.medicine_id = hi.medicine_id JOIN schedule s ON hi.schedule_id = s.schedule_id JOIN notification n ON n.medicine_id= $medicid AND n.patient_id = $userid WHERE TIME(notification_time) > TIME(NOW()) ORDER BY n.notification_time";
